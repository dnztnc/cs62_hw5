...
public class WordleGWindow {
    ...
    /** The default square color (white). */
    public static final Color DEFAULT_SQUARE_COLOR = new Color(0xFFFFFF);

    /** The default keyboard color (light gray). */
    public static final Color DEFAULT_KEY_COLOR = new Color(0xDDDDDD);
